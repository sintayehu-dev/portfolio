...
const projects = [
  ...
  },
  {
    ...
    detailedDescription: "A full‑stack restaurant application delivering a smooth ordering experience. The Flutter client (BLoC, feature‑first) provides category search, rich menu pages, dietary filters, and a streamlined cart/checkout. Orders update in real time with status notifications and digital receipts. The Golang backend offers JWT‑secured REST APIs, role‑based admin for menu/pricing, and integrations with payment gateways. It supports promo codes, taxes/fees, and order throttling during peak hours. Images are optimized with caching and responsive sizes to keep UI fast on mobile networks. The system is designed for operational reliability with retries, idempotent order endpoints, and clear error states for payment edge cases.",
